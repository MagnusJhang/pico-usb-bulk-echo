...
//--------------------------------------------------------------------+
// BOS Descriptor (Corrected Constants)
//--------------------------------------------------------------------+
#define VENDOR_REQUEST_MICROSOFT 0x01

uint8_t const desc_bos[] = {
    TUD_BOS_DESC_LEN, TUSB_DESC_BOS, 1,
    // MS OS 2.0 Platform Capability
    18, TUSB_DESC_DEVICE_CAPABILITY, 0x05, 0x00, // 0x05 is TUSB_DESC_DEVICE_CAPABILITY_PLATFORM
    0x67, 0x39, 0xDD, 0xD8, 0x10, 0xA3, 0xFA, 0x42, 0x95, 0x62, 0x37, 0x3D, 0x7E, 0x7A, 0x5D, 0x7C,
    0x00, 0x00, 0x03, 0x06, 
    VENDOR_REQUEST_MICROSOFT, 0x00 
};
...
//--------------------------------------------------------------------+
// MS OS 2.0 Descriptor Set (Corrected Typo: COMPATBLE)
//--------------------------------------------------------------------+
uint8_t const desc_ms_os_20[] = {
    ...
    0x08, 0x00, MS_OS_20_SUBSET_HEADER_FUNCTION, ITF_NUM_VENDOR, 0x00, 0xA0, 0x00,
    // Note: TinyUSB constant is MS_OS_20_FEATURE_COMPATBLE_ID (missing 'i')
    0x14, 0x00, MS_OS_20_FEATURE_COMPATBLE_ID, 'W', 'I', 'N', 'U', 'S', 'B', 0x00, 0x00,
