...
//--------------------------------------------------------------------+
// String Descriptors (MS OS 1.0 Support for backward compatibility)
//--------------------------------------------------------------------+
...
//--------------------------------------------------------------------+
// MS OS 2.0 Descriptor Set (The Most Robust Version)
//--------------------------------------------------------------------+
...
uint8_t const desc_ms_os_20[] = {
  ...
  // Registry property: size=124, type=4, data_type=1 (REG_SZ), name_len=42, name="DeviceInterfaceGUID"
...
uint8_t const desc_bos[] = {
    ...
    // MS OS 2.0 UUID: D8DD3967-A310-42FA-9562-373D7E7A5D7C (Microsoft Standard)
    0x67, 0x39, 0xDD, 0xD8, 0x10, 0xA3, 0xFA, 0x42, 0x95, 0x62, 0x37, 0x3D, 0x7E, 0x7A, 0x5D, 0x7C,
    0x00, 0x00, 0x03, 0x06, // dwWindowsVersion
    0xA2, 0x00,             // wMSOSDescSetTotalLength (162 bytes = 0xA2)
